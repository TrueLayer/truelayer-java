 ...
 * @see ApiResponse
 */
final class TrueLayerAsyncResponseCallAdapter<R> implements CallAdapter<R, CompletableFuture<ApiResponse<R>>> {
    private final Type responseType;
    private final ErrorMapper errorMapper;

    TrueLayerAsyncResponseCallAdapter(Type responseType) {
