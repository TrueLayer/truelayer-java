...
public final class Constant {
    ...
    public static final String PAYMENT_STATUS_REGEX = "^(" + Status.AUTHORIZATION_REQUIRED + "|"
            + Status.AUTHORIZING + "|"
            + Status.AUTHORIZED + "|"
            + Status.EXECUTED + "|"
            + Status.SETTLED + "|"
    ...
    public static final String COUNTRY_CODE_REGEX =
            "^(" + CountryCode.GB + "|" + CountryCode.FR + "|" + CountryCode.IE + ")$";
    public static final String CURRENCY_REGEX = "^(" + CurrencyCode.GBP + "|" + CurrencyCode.EUR + ")$";

    public static final String ISO_8106_REGEX =
