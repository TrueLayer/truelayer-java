...
[![License](https://img.shields.io/:license-mit-blue.svg)](https://truelayer.mit-license.org/) [![Build and tests](https://github.com/TrueLayer/truelayer-java/actions/workflows/build-and-tests.yml/badge.svg)](https://github.com/TrueLayer/truelayer-java/actions/workflows/build-and-tests.yml) [![Coverage Status](https://coveralls.io/repos/github/TrueLayer/truelayer-java/badge.svg?branch=jsdk-28&t=gcGKQv)](https://coveralls.io/github/TrueLayer/truelayer-java?branch=jsdk-28)
