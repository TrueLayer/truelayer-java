...
public interface IHostedPaymentPageLinkBuilder {
     ...
     * @param payment_token the token of the payment created with a previous call to the Create Payment endpoint
     ...
     */
    URI getHostedPaymentPageLink(String paymentId, String payment_token, URI returnUri);
}
